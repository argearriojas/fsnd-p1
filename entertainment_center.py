...
hgttg = media.Movie(
    ...
    ("https://upload.wikimedia.org/wikipedia/en/7/7a/"
        "Hitchhikers_guide_to_the_galaxy.jpg"),
...
limitless = media.Movie(
    ...
    ("With the help of a mysterious pill that enables the user to access 100 "
        "percent of his brain abilities, a struggling writer becomes a "
        "financial wizard, but it also puts him in a new world with lots of "
        "dangers."),
...
fightclub = media.Movie(
    ...
    ("An insomniac office worker, looking for a way to change his life, "
        ...
        "underground fight club that evolves into something much, "
        "much more..."),
...
lifeisbeautiful = media.Movie(
    ...
    ("When an open-minded Jewish librarian and his son become victims of the "
        "Holocaust, he uses a perfect mixture of will, humor and imagination "
        "to protect his son from the dangers around their camp."),
...
thegreenmile = media.Movie(
    ...
    ("The lives of guards on Death Row are affected by one of their charges: "
        "a black man accused of child murder and rape, yet who has a "
        "mysterious gift."),
...
braveheart = media.Movie(
    ...
    ("When his secret bride is executed for assaulting an English soldier who "
        "tried to rape her, William Wallace begins a revolt and leads "
        "Scottish warriors against the cruel English tyrant who rules "
        "Scotland with an iron fist."),
...
vforvendetta = media.Movie(
    ...
    ("In a future British tyranny, a shadowy freedom fighter, known only by "
        "the alias of \"V\", plots to overthrow it with the help of a young "
        "woman."),
...
howtotrainyourdragon = media.Movie(
    ...
    ("A hapless young Viking who aspires to hunt dragons becomes the unlikely "
        "friend of a young dragon himself, and learns there may be more to "
...
groundhogday = media.Movie(
    ...
    ("https://upload.wikimedia.org/wikipedia/en/b/b1/"
        "Groundhog_Day_%28movie_poster%29.jpg"),
    "https://www.youtube.com/watch?v=tSVeDx9fk60")
kingsspeech = media.Movie(
    "The King's Speech",
    "2010",
    ("The story of King George VI of the United Kingdom of Great Britain and "
        "Northern Ireland, his impromptu ascension to the throne and the "
        "speech therapist who helped the unsure monarch become worthy of it."),
    ("http://3.bp.blogspot.com/_LG5VeWc_two/TT3PCZE2poI/AAAAAAAACos/"
        "7YhH6ItfGNc/s1600/King_Speech_12915032823333.jpg"),
